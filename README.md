...
- Your compiled binary [`photo-old`](https://github.com/rodrigoFMachado/Parallel-Vintage-Photo/blob/main/scripts/runner.sh#L30) must be inside the `build/` directory.
...
- **Thread configuration**  
  ...
  ```  
  You can modify this line in [`runner.sh`](https://github.com/rodrigoFMachado/Parallel-Vintage-Photo/blob/main/scripts/runner.sh#L14) to customize the thread counts.
